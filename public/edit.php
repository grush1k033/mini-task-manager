...
<head>
    ...
    <title>✏️ Редактировать товар - Modern Store</title>
    ...
    <div class="form-container">
        <div class="form-card">
            <div class="form-header">
                ...
                <h2 class="mb-2">Редактировать товар</h2>
                <p class="mb-0">Обновите информацию о товаре #<?= $product->id ?></p>
            </div>
            ...
            <div class="form-body">
                ...
                <div class="product-info">
                    ...
                    <div class="product-info-item">
                        ...
                        <span class="info-value"><?= date('d.m.Y H:i', strtotime($row['created_at'])) ?></span>
                    </div>
                </div>
                ...
                <form method="POST">
                    ...
                    <div class="floating-label">
                        <input type="text" name="title" class="form-control"
                               value="<?= htmlspecialchars($product->title) ?>" placeholder=" " required>
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="number" step="0.01" name="price" class="form-control"
                                       value="<?= htmlspecialchars($product->price) ?>" placeholder="0.00" required>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        inputs.forEach(input => {
            // Автоматически активируем floating labels для заполненных полей
            if (input.value) {
